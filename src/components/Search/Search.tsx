  ...
  return (
    <React.Fragment>
      <div className={styles.searchWrapper}>
        <div
          className={
            focus ? styles.search + " " + styles.noItems : styles.search
          }
        >
          <span className={styles.sendBtn} onClick={handleSendClick}>
            <BsFillSendFill />
          </span>
          <input
            type="text"
          ...
          />
          <span className={styles.cancelBtn} onClick={handleCancelClick}>
            <MdOutlineClose />
          </span>
        </div>
