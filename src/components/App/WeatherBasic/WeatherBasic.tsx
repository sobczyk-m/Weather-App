            ...
            <div id={styles.weather}>
                ...
                <div id={styles.description}>
                    <div id={styles.leftColumn}>
                        <figure>
                            <img id={styles.icon} src={getWeatherIcon(weather!.iconCode, "large")}
                                 alt={"Weather condition"}/>
                            <figcaption id={styles.iconDescription}>{weather?.iconDescription}</figcaption>
                        </figure>
                    </div>
                    <div id={styles.rightColumn}>
                        <div id={styles.temp}>{weather?.temp}<span
