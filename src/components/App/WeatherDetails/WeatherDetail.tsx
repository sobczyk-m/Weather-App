                ...
                <ul className={styles.details}>
                    <li className={styles.airDetail}>
                        <p className={styles.airValue}>
                            ...
                            <span>{air!.components.pm2_5.toFixed(0)} μg/m<sup>3</sup></span>
                            <span
                                className={styles.directive}>{((air!.components.pm2_5 / whoAirQualityDirectives["PM2.5"]) * 100).toFixed()}%</span>
                        </p></li>
                    <li className={styles.airDetail}>
                        <p className={styles.airValue}>
                            <span>PM<sub>10</sub>:</span><span
                        >{air!.components.pm10.toFixed(0)} μg/m<sup>3</sup></span> <span
                            className={styles.directive}>{((air!.components.pm10 / whoAirQualityDirectives.PM10) * 100).toFixed()}%</span>
                        </p></li>
                    <li className={styles.airDetail}>
                        <p className={styles.airValue}>
                            <span>NO<sub>2</sub>:</span>
                            <span>{air!.components.no2.toFixed(0)} μg/m<sup>3</sup></span>
                            <span
                                className={styles.directive}>{((air!.components.no2 / whoAirQualityDirectives.NO2) * 100).toFixed()}%</span>
                        </p></li>
                    <li className={styles.airDetail}>
                        <p className={styles.airValue}>
                            <span>O<sub>3</sub>:</span>
                            <span>{air!.components.o3.toFixed(0)} μg/m<sup>3</sup></span> <span
                            className={styles.directive}>{((air!.components.o3 / whoAirQualityDirectives.O3) * 100).toFixed()}%</span>
                        </p></li>
                    <li className={styles.airDetail}>
                        <p className={styles.airValue}>
                            <span>SO<sub>2</sub>:</span>
                            <span>{air!.components.so2.toFixed(0)} μg/m<sup>3</sup></span>
                            <span
                                className={styles.directive}>{((air!.components.so2 / whoAirQualityDirectives.SO2) * 100).toFixed()}%</span>
                        </p></li>
                    <li className={styles.airDetail}>
                        <p className={styles.airValue}><span>CO:</span>
                            <span>{air!.components.co.toFixed(0)} μg/m<sup>3</sup></span><span
                                className={styles.directive}>{((air!.components.co / whoAirQualityDirectives.CO) * 100).toFixed()}%</span>
                        </p></li>
                </ul>
                :
                <ul className={styles.details}>
